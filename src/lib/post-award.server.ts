...
export const getReportingDeadlines = createServerFn({
  ...
  // Get outcomes with reporting requirements
  let query = supabase
    .from("outcomes")
    .select(
      `
  ...
  // Generate reporting deadlines based on funder requirements
...
export {
  getSubmissionOutcomes as outcomes,
  getAwardMetrics as metrics,
  getReportingDeadlines as deadlines,
  generateOutcomeReport as report,
};
