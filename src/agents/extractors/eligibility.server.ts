...
const RULES: Rule[] = [
  ...
  { tag: "non_profit", patterns: [
    /\bnon[-\s]?profits?\b/i, /\bnot[-\s]for[-\s]profits?\b/i, /\bNPOs?\b/, /\bcharit(?:y|ies)\b/i,
    /\borganisations?\s+(?:à\s+but\s+non\s+lucratif|sans\s+but\s+lucratif)\b/i, /\bOBNL\b/, /\bOSBL\b/,
  ]},
  { tag: "for_profit", patterns: [
    /\bfor[-\s]?profits?\b/i, /\bcommercial\s+enterprises?\b/i, /\bincorporated\s+businesses?\b/i,
    /\bà\s+but\s+lucratif\b/i, /\bentreprises?\s+commerciales?\b/i,
  ]},
  ...
  { tag: "government", patterns: [
    /\bmunicipalit(?:y|ies)\b/i, /\blocal\s+governments?\b/i, /\bprovincial\b/i,
    /\badministrations?\s+locales?\b/i, /\bmunicipalités?\b/i,
  ]},
  { tag: "individual", patterns: [
    /\bindividuals?\b/i, /\bcitizens?\b/i, /\bstudents?\b/i, /\bresearchers?\b/i,
    /\bindividus?\b/i, /\bétudiants?\b/i, /\bchercheurs?\b/i,
  ]},
  ...
  { tag: "research_university", patterns: [/\buniversit(?:y|ies|é|és)\b/i, /\bresearch\s+institut(?:e|ion)s?\b/i, /\bcentres?\s+de\s+recherche\b/i, /\bpost[-\s]secondary\b/i] },
